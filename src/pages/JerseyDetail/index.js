...
class JerseyDetail extends Component {
  ...
  render() {
    ...
    const {jersey, images, jumlah, keterangan
      // , ukuran
    } = this.state;
    return (
        ...
        <View style={styles.container}>
          ...
          <View style={styles.desc}>
            ...
            <Text style={styles.harga}>
              Price : Rp. {numberWithCommas(jersey.harga)}
              <Text style={styles.harga}> Per KG</Text>
            </Text>

            <View style={styles.garis} />

            <View style={styles.wrapperJenisBerat}>
              <Text style={styles.jenisBerat}>Wash and Iron your Clothes Cheaply</Text>
              {/* <Text style={styles.jenisBerat}>Berat : {jersey.berat}</Text> */}
            </View>

            <View style={styles.wrapperInput}>
              <Inputan
                placeholder="Weight (Max. 8 KG)"
